 ...
 * When the audio file is very large, and sti->index_entries has limited capacity.
 * At this time, the function ff_reduce_index() will be called more than once and halved sti->index_entries.
 * The timestamp queried is far from the actual timestamp, and the sti->index_entries needs to be refreshed.
 */
