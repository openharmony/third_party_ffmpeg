...
FF_CONFIG_OPTIONS="
    ...
    --enable-decoder=mp2,mp3,mp3float,aac,aac_latm,ape,flac,vorbis,opus,amrnb,amrwb,ac3,gsm_ms,wmav1,wmav2,wmapro,adpcm_g722,adpcm_g726,adpcm_ima_wav,adpcm_ms,adpcm_yamaha,gsm,alac
