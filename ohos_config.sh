...
FF_CONFIG_OPTIONS="
    ...
    --enable-parser=h263,h264,mpeg4video,vp8,vp9,mpegvideo,mjpeg,cinepak
    --enable-parser=mpegaudio,aac,aac_latm,av3a,amr,opus,ac3,gsm,gsm_ms,ilbc
    --enable-decoder=h263,h264,mpeg2video,mpeg4,vp8,vp9,wmv3,msvideo1,mjpeg,cinepak
    ...
    --enable-decoder=h263,h264,mpeg2video,mpeg4,vp8,vp9,wmv3,msvideo1,mjpeg
