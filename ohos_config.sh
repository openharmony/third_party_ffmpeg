...
FF_CONFIG_OPTIONS="
    ...
    --disable-lzma
    --disable-vulkan
    --enable-demuxer=mp3,aac,ape,flac,ogg,wav,mov,mpegts,amr,amrnb,amrwb,matroska,flv,mpegps,asf,asf_o,srt,h264,webvtt,avi
    ...
    --enable-decoder=mp1,mp2,mp3,mp3float,aac,aac_latm,ape,flac,vorbis,opus,amrnb,amrwb
