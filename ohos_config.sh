...
FF_CONFIG_OPTIONS="
    ...
    --enable-demuxer=m4v,h263,hevc,ingenient,mjpeg,mpegvideo,rawvideo
    ...
    --enable-encoder=asv1,asv2,avrp,ayuv,ffvhuff,mjpeg,pbm,pgm,pgmyuv,ppm,r10k,r210,v408,aptx,aptx_hd,mlp,sonic,sonic_ls,truehd,wmav1,wmav2,pcm_alaw,pcm_f32be,pcm_f32le,pcm_f64be,pcm_f64le,pcm_mulaw,s8,s8_planar,pcm_s16be,pcm_s16be_planar,pcm_s24be,pcm_s24daud,pcm_s24le,pcm_s24le_planar,pcm_s32be,pcm_s32le,pcm_s32le_planar,adpcm_g726le,dvvideo,dvaudio,h263
